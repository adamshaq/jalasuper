                ...
                <div class="card-body">
                    <div id="bagian-tabel">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-float">
                                    <label class="form-group-float-label is-visible">KPP</label>
                            ...
                            <table class="table datatable-pagination" id="tabel-data">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Jenis User</th>
                                        <th id="tbl_company_id_table">KPP ID</th>
                                        <th>KPP</th>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-float">
                                        ...
                                        <select name="user_tp" data-placeholder="pilih salah satu" class="form-control form-control-select2 select-search" required data-fouc>
                                            <option value="USER_TP_2">Administrator KPP</option>
                                            <option value="USER_TP_3">Pegawai</option>
                                        </select>
                                    </div>
                                </div>
...
<script>
    ...
    $(document).ready(function(){
        ...
        $(document).on('click', '#profil',function(){ 
            ...
            window.location = '/data-master/user/profil/'+dataCd;
        });
