...
@section('content')
	...
	<div class="card">
		<div class="card-header header-elements-inline">
			<h5 class="card-title">Data KPP</h5>
			...
			<div id="bagian-tabel">
                ...
                <div class="table-responsive">
					<table class="table datatable-pagination" id="tabel-data">
						<thead>
							<tr>
								<th width="15%" id="tbl_company_id_table">Kode KPP</th>
                                <th width="25%" id="company_nm_table">Nama KPP</th>
			...
			<div id="bagian-form">
				<form class="form-validate-jquerys" id="form-isian" action="#">
					...
					<div class="row">
                        <div class="col-md-6">
                            <div class="form-group form-group-float">
                                <label class="form-group-float-label is-visible">Kode KPP</label>
                                <input type="text" name="tbl_company_id" class="form-control"  required="" placeholder="" aria-invalid="false" />
                            </div>
                        </div>
						<div class="col-md-6">
							<div class="form-group form-group-float">
								<label class="form-group-float-label is-visible">Nama KPP</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-float">
                                <label class="form-group-float-label is-visible">Alamat KPP</label>
...
<script>
    ...
    $(document).ready(function(){
		...
		tabelData = $('#tabel-data').DataTable({
            ...
            order		: [[4,'ASC']], 
            ajax		: {
                url: "{{ url('/data-master/company/data') }}",
                type: "POST",
                data: {
        ...
        $('#form-isian').submit(function(e){
            ...
            // handle the invalid form...
                ...
                if(saveMethod == 'tambah'){
                    var url     = '{{ url("/data-master/company/") }}';
                    var method  = 'POST';
                }else{
                    var url     = '{{ url("/data-master/company/") }}'+'/'+dataCd;
                    var method  = 'PUT';
                }
        ...
        $(document).on('click', '#hapus',function(){    
            ...
            swal({
                ...
                if(result.value){
                    ...
                    $.ajax({
                        url : '{{ url("/data-master/company/") }}'+'/'+dataCd,
                        type: "DELETE",
                        dataType: "JSON",
                        data: {
