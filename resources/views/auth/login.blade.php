                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="text-center mb-3">
                                <img src="/images/atlas.png" class="img-fluid mb-3" width="300" height="150" alt="">
                                <h5 class="mb-0">Login ke akun Anda</h5>
                                <span class="d-block text-muted">{{env('APP_NAME')}}</span>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="submit" class="btn btn-primary btn-block">{{ __('Masuk') }} <i class="icon-circle-right2 ml-2"></i></button>
                            </div>

                            <div class="text-center">
								<a href="/">{{ __('Kembali Ke Halaman Utama') }}</a>
							</div>

                            <span class="form-text text-center text-muted">{{env('APP_INST')}}</span>
                        </div>
                    </div>
                </form>
                <!-- /login form -->
